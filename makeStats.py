...
for line in open('OceanGenomes.CuratedNT.NBDLTranche1.CuratedBOLD.taxids.taxonkit'):
...
with open('OceanGenomes.CuratedNT.NBDLTranche1.CuratedBOLD.taxids.taxonkit_species','w') as out:
    out.write('Species\tSpecies count\n')
    for l in spec_dict:
        out.write(f'{l}\t{spec_dict[l]}\n')


with open('OceanGenomes.CuratedNT.NBDLTranche1.CuratedBOLD.taxids.taxonkit_genus','w') as out:
